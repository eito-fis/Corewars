...
export class Seq extends Command {
    ...
    _call(processes, process_index, gen){
        ...
        switch(this.mod){
            case 'A': 
                this._compare((this.memory_buffer[acheck].a == this.memory_buffer[bcheck].a), processes_process, index)
                break
            case 'B': 
                this._compare((this.memory_buffer[acheck].b == this.memory_buffer[bcheck].b), processes_process, index)
                break
            case 'AB':
                this._compare((this.memory_buffer[acheck].a == this.memory_buffer[bcheck].b), processes_process, index)
                break
            case 'BA':
                this._compare((this.memory_buffer[acheck].b == this.memory_buffer[bcheck].a), processes_process, index)
                break

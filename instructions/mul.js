...
export class Mul extends Command {
	...
	_call(processes, process_index){
        ...
        switch(this.mod){
            case "A":
                this.memory_buffer[dest].a = this._mul(this.memory_buffer[source].a, this.memory_buffer[dest].a)
                break
            case "B":
                this.memory_buffer[dest].b = this._mul(this.memory_buffer[source].b, this.memory_buffer[dest].b)
                break
            case "AB":
                this.memory_buffer[dest].b = this._mul(this.memory_buffer[source].a, this.memory_buffer[dest].b)
                break
            case "BA":
                this.memory_buffer[dest].a = this._mul(this.memory_buffer[source].b, this.memory_buffer[dest].a)
                break
            case "F": case "I":
                this.memory_buffer[dest].a = this._mul(this.memory_buffer[source].a, this.memory_buffer[dest].a)
                this.memory_buffer[dest].b = this._mul(this.memory_buffer[source].b, this.memory_buffer[dest].b)
